...
export default function SiteFooter() {
  return (
    <footer id="kontak" className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-linear-to-b from-brand-500/35 from-0% via-white/80 via-20% to-accent-950 to-43%" />
      ...
      <div className="relative z-10">
        <div className="mx-auto max-w-6xl px-6 pt-28 pb-24">
          ...
          <h2 className="mt-5 max-w-lg text-3xl leading-tight font-semibold tracking-tight text-ink sm:text-4xl">
        ...
        <div className="mx-auto max-w-6xl px-6 pb-16">
          <div className="grid gap-12 border-t border-white/15 pt-16 sm:grid-cols-2 lg:grid-cols-4">
            <div>
